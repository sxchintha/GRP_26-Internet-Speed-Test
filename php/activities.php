        ...
        if (!empty($_POST['ISP']) && !empty($_POST['district'])) {
          ...
          foreach ($_POST['ISP'] as $ispVal) {
            foreach ($_POST['district'] as $districtVal) {
              ...
              $sql="SELECT ispinfo,dl as dlSpeed,ul as ulSpeed,district, ip, timestamp, ping from `speedtest_users` where ispinfo like '%$ispVal%' and district='$districtVal' and user='$user' ";
              ...
              if($result == nul) {
                ...
                <tr>
                  ...
                  <th>Date and Time</th>
                  <th>ISP</th>
                  <th style="padding-top: 5px; padding-bottom: 5px;">Download Speed<br>(Mbps)</th>
                  <th>Upload Speed<br>(Mbps)</th>
                  <th>Ping</th>
                  <th>District</th>
                </tr>';
                $chkHead = 1;
              ...
              <tr>
                ...
                <td style="text-align: center;"><?php echo $row["ping"]; ?></td>
